...
const Shoplogin = () => {
    ...
    const login = async (Phonenumber, Password) => {
        ...
        const response = await fetch(`http://${ip.ip}:3001/app/loginstation`, {
            method: "POST",
            headers: {
    ...
    const image = { uri: 'https://www.en-plustech.com/uploads/eb74992c1.jpg' };
    return (
        <>
            ...
            <View className="p-6 w-full text-white  pb-10 absolute flex-1 justify-center h-screen" style={{ "backgroundColor": " rgba(0, 0, 0, 0.55)" }}>
                ...
                <View className="w-full flex flex-row mt-3 text-center justify-center">
                    <Text style={{ textAlign: 'center' }} className="text-white">A vehicle owner? </Text>
